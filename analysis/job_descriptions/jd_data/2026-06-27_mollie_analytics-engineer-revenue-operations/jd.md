...
**velocity_vs_rigour:** rigour — The responsibilities emphasise "serving as the source of truth for commercial stakeholders" and "centralised, standardised reporting", with rigour signals dominating over a single velocity-adjacent mention of "fast-moving environment" in requirements.

**domain_risk:** moderate — Mollie is fintech/payments but the JD language is generic commercial ops; the decisive phrase is "feeds directly into how commercial teams make decisions", without explicit financial reporting, compliance, or regulatory framing.

**collaboration_width:** 4 — named teams: Sales; Customer Success; Marketing; Partnerships

**data_team_maturity:** mid — "RevOps has recently adopted a full domain model and is being rebuilt as a proper product and engineering function" signals a function that exists but is actively being restructured and matured.

**jd_authorship:** mixed — "Reduce dashboard sprawl by establishing centralised, standardised reporting in Omni" and "Own and maintain HubSpot data models" show specific technical context, alongside generic bullets like "Deliver ad hoc analysis and impact scoping to support decision-making".

**stakeholder_orientation:** commercial — The role's primary audience and impact is explicitly framed around commercial team decision-making, GTM enablement, and sales/customer success operations rather than product, finance, or internal platform work.
**autonomy_level:** mixed — The role combines strategic ownership (defining how analytics is delivered, establishing standardised reporting, defining success metrics) with execution (maintain dashboards, deliver ad hoc analysis), making it genuinely mixed rather than purely strategic or execution-focused.
**greenfield_vs_fix:** mixed — Role involves both building new standardised reporting infrastructure ("Reduce dashboard sprawl by establishing centralised, standardised reporting in Omni") and maintaining existing assets ("Own and maintain core dashboards").

**urgency:** standard — No urgency signals present.

**language_gate:** none — Not stated in JD (CV requested in English but no non-English language requirement).

**interview_stages:** Not stated in JD

**ats_platform:** ashby

**ats_job_id:** 06baf630-1c65-4b77-b7fa-35c65b43447d

**loss_aversion:** "When the data is right, the whole commercial engine runs better" frames data correctness as an enabler but does not use explicit risk/reliability framing. No strong loss aversion detected.
...
- HubSpot data models
- dashboard sprawl
- centralised, standardised reporting
- Omni
- source of truth for commercial stakeholders
- go-to-market motion
- data modelling concepts
- commercial or sales-facing environment
