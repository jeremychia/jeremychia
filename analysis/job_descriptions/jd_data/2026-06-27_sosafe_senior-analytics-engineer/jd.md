...
**velocity_vs_rigour:** rigour — The responsibilities are dominated by quality and correctness signals: "Establish and enforce best practices in testing, documentation, and data quality- making these part of the standard development lifecycle."

**domain_risk:** moderate — SoSafe is a cybersecurity SaaS scale-up; data errors affect business decisions (activation, engagement, retention metrics) but the JD uses no financial reporting, regulatory, or compliance language for the data role itself.

**collaboration_width:** 2 — named teams: "Collaborate with Data Engineers on upstream data contracts and event schemas"; "ensuring consistent definitions across analytics, product, and AI use cases"

**data_team_maturity:** mid — The role is to own and extend an existing dbt transformation layer and build out a semantic layer, indicating the data function is in active growth ("Build and evolve our semantic layer").
...
**language_gate:** hard — "Fluent in English." (English only, no non-English language requirement)

**interview_stages:** Not stated in JD

**ats_platform:** ashby

**ats_job_id:** 86d983aa-252a-41c6-8ef1-58b40cd6f23a

**loss_aversion:** No loss aversion framing detected. The JD uses positive-outcome language ("make a difference", "part of the solution") rather than risk-reduction framing.
...
- data contracts
- event schemas
- modular well-tested data models
- SaaS data modeling
