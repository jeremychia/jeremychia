...
Vinted commits to inclusive hiring practices welcoming applicants regardless of race, age, religion, sex, national origin, citizenship, gender identity, sexual orientation, disability, or other protected characteristics.

---

## Layer B — Behavioural Analysis

**velocity_vs_rigour:** rigour — Responsibilities are dominated by quality, standards, and reliability signals: "Maintain architectural standards, data quality, and operational excellence" and requirements call for "testing, documentation, lineage, data quality, and observability" — no velocity signals present.

**domain_risk:** moderate — Vinted is an e-commerce/marketplace platform; the role covers Revenue, Purchase, and Orders domains but JD language uses no financial reporting, compliance, or regulatory framing ("strategic technical oversight across Revenue, Purchase, and Orders domains").

**collaboration_width:** 4 — named teams: Revenue domain; Purchase domain; Orders domain; analytics engineers (cohort being mentored)

**data_team_maturity:** mature — The role exists to coordinate architectural direction across multiple named domain sub-teams (Revenue, Purchase, Orders) with a dedicated Area Lead title, implying a large, specialised data function ("Ability influencing technical direction across multiple teams").
...
**language_gate:** none — English fluency required but no non-English language requirement stated.

**interview_stages:** Not stated in JD

**ats_platform:** greenhouse

**ats_job_id:** 4838170101

**loss_aversion:** The JD frames reliability and architectural integrity as core values: "Maintain architectural standards, data quality, and operational excellence" and "Balance between local delivery and long-term architectural integrity" both carry loss-aversion framing around technical debt and degradation risk.

**ATS keywords:**
- analytics engineering principles
- data modeling and pipelines at scale
