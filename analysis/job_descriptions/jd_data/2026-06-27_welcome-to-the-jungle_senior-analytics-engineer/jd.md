...
**velocity_vs_rigour:** rigour — Responsibilities emphasise correctness and governance: "developing robust and efficient data pipelines and data models", plus "setting up standards and guidelines", "applying the first levels of governance", and "well documented and well govern". No velocity signals present.

**domain_risk:** moderate — HR tech / job board SaaS; data errors affect business decisions but no financial reporting, compliance, or regulatory language. Decisive phrase: "Make our data ready to use by our end-users".

**collaboration_width:** 3 — named teams: Data Engineers (DE); Data Analysts (DA); Data Scientists (DS)

**data_team_maturity:** mid — Named tools already deployed in responsibilities context ("our Data Warehouse", "our BI tools"), multiple data roles already exist (DE, DA, DS, AE). Role exists to grow and consolidate an existing function. Decisive phrase: "building up our data assets and consolidating existing ones".
...
**language_gate:** none — No non-English language requirement stated.
...
- architecting scalable transformations and frameworks
