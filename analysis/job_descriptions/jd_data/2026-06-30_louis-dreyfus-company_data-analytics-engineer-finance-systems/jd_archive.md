...
Education
Bachelor's or Master's degree in Computer Science, Information Systems, Engineering, Mathematics, Economics, Finance Technology, or a related field.

Experience
Experience in Software Development, Data Engineering, Business Intelligence, ERP Systems, Financial Systems, or similar technical roles. Internship experience is welcomed. Experience with OneStream, SAP, Oracle, NetSuite, Power BI, Tableau, ETL tools, or similar platforms is considered an advantage but is not required.

Technical Skills
SQL and database fundamentals. Programming experience with Python, C#, Java, VB.NET, or similar languages. Understanding of data integration and data transformation concepts. Interest in analytics, reporting, and financial systems. Familiarity with Git, Azure DevOps, or software delivery processes is a plus.

Personal Qualities
Analytical mindset and strong problem-solving skills. Curiosity and willingness to learn new technologies. Strong communication and collaboration skills. Ownership and attention to detail. Ability to work effectively in a global and multicultural environment.

Nice-to-Have Skills
Exposure to cloud technologies, automation, or APIs. Knowledge of Power BI, data visualization, or reporting tools. Interest in Python-based analytics, machine learning, or process automation. Understanding of financial processes such as reporting, budgeting, forecasting, or consolidation.