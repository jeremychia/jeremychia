...
**velocity_vs_rigour:** rigour — Rigour signals dominate — data quality, governance, reliability, professionalisering van processen — with no velocity phrases present; classified as rigour.

**domain_risk:** low — Education sector with societal impact framing; no financial reporting or regulatory compliance language; errors affect internal decisions not regulated outputs; classified as low.

**collaboration_width:** 2 — named teams: business teams; data-analisten en experts in Nederland

**data_team_maturity:** mid — Small but established team (one peer in BE, larger group in NL); named tools appear in responsibilities (SQL, Snowflake, Power BI); 'verdere professionalisering' signals growing not early-stage; classified as mid.

**jd_authorship:** mixed — Some technically specific bullets (named stack in responsibilities, platform-building scope) alongside generic ones (business teams ondersteunen, insights communiceren); classified as mixed.

**stakeholder_orientation:** internal_data — Primary emphasis on building the data platform, data literacy, and professionalising internal data processes — classic internal_data orientation; business team support is secondary.

**autonomy_level:** mixed — Genuine split between autonomous end-to-end ownership (strategic) and supporting business teams (execution); classified as mixed.

**greenfield_vs_fix:** mixed — Mix of building new dashboards/solutions (greenfield) and professionalising existing processes (fix_scale) with neither strongly dominant; classified as mixed.

**urgency:** standard — No urgency signals present.

**language_gate:** soft — "Je kan professioneel communiceren in het Frans of bent bereid dit verder te versterken"
