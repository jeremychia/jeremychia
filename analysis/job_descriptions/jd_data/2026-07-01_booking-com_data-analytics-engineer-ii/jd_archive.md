...
Requirements:
- 3+ years of experience of designing, building, and optimising Data Lakes/Warehouses in databases such as Snowflake, Redshift, BigQuery, etc.
- 2+ years of experience in a scripting language like Python or Scala.
- 1+ years of experience in Streaming, using Kafka.
...
- Modelling data following best practices and Data Warehousing methodologies such as Data Vault and (Kimball) Dimensional modelling.
- Self motivated to explore new technologies.
- Excellent communication skills.
- Excellent attention to detail.

Bonus Points For:
- Experience with Airflow, Snowflake, pySpark.
