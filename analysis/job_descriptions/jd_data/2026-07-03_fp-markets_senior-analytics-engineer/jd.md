...
*3-run LLM consistency check: `../state_of_analytics_engineering/jd_traces/2026-07-03_fp-markets_senior-analytics-engineer.md` (generated by `classify_jds.py`, may not exist yet)*

**velocity_vs_rigour:** rigour — Rigour: validation, testing, documentation, and lineage ownership dominate; no velocity/speed language present.

**domain_risk:** high — High: fintech/trading platform with explicit regulatory (CySEC/MiFID II/GDPR/DORA) and compliance (KYC/AML) language signals high domain risk.

**collaboration_width:** 4 — named teams: Finance; Risk; Operations; Product; Business Development

**data_team_maturity:** early — Early: greenfield platform build with defined direction; team is being established; candidate helps shape foundation and processes.

**jd_authorship:** hiring_manager — Hiring manager: highly specific technical ownership (dbt models, Superset dashboards, validation logic, lineage) with concrete day-to-day context shows deep domain expertise.

**stakeholder_orientation:** finance — Finance: primary audience is financial/risk teams for trading metrics, regulatory reporting, and financial compliance.

**autonomy_level:** strategic — Strategic: candidate sets direction for analytics foundation, owns complete delivery cycle, shapes platform decisions, and drives validation standards.

**greenfield_vs_fix:** greenfield — Greenfield: explicit greenfield signal; team building platform from scratch; direction set but execution/foundation shaping is candidate's role.
...
**loss_aversion:** Validate the numbers. Every chart has a known-good ground truth. You can defend any number on any dashboard, with reasoning and reproducible queries. Knowledge of CySEC / MiFID II / GDPR / DORA.
