...
*3-run LLM consistency check: `../state_of_analytics_engineering/jd_traces/2026-07-06_fullenrich_analytics-engineer.md` (generated by `classify_jds.py`, may not exist yet)*

**velocity_vs_rigour:** velocity — The JD explicitly frames the culture around rapid execution, AI-accelerated speed, and 'buy, don't build', with only a passing mention of data quality rigor, so velocity dominates.

**domain_risk:** moderate — The role affects business/commercial decisions (unit economics, churn prediction) at a B2B SaaS startup without regulatory or financial-reporting consequences, keeping it moderate.

**collaboration_width:** 4 — named teams: Sales; Marketing; Finance; Product

**data_team_maturity:** early — This is explicitly the company's first full-time data hire, tasked with creating the data team and function from scratch, a clear early-stage signal.

**jd_authorship:** hiring_manager — Precise named tools (BigQuery, dbt Cloud, Fivetran, Airbyte, Segment, Basedash, Cursor, Claude Code) and concrete two-phase mission give a clear picture of daily work, consistent with hiring-manager authorship.

**stakeholder_orientation:** commercial — The strategic phase of the role centers on revenue-driving business analyses (unit economics, churn, activation scoring) tied to sales/RevOps outcomes, a commercial orientation.

**autonomy_level:** strategic — The candidate is explicitly tasked with becoming a highly strategic partner driving business-pivoting analyses, a clear strategic ownership framing.

**greenfield_vs_fix:** greenfield — The mission is explicitly to create the data team and push the stack further as the first data hire, a greenfield framing despite inheriting clean foundations.
