# Analytics Engineer — FullEnrich (Licorne Society)
...
*3-run LLM consistency check: `../state_of_analytics_engineering/jd_traces/2026-07-11_licorne-society_analytics-engineer.md` (generated by `classify_jds.py`, may not exist yet)*

**velocity_vs_rigour:** velocity — Velocity dominates: repeated emphasis on speed (hyper-growth, rapid execution, fast-paced), AI-native culture, and deployment velocity outweigh rigour signals.

**domain_risk:** moderate — B2B SaaS selling data products—errors affect commercial decisions without regulatory/financial reporting consequence, placing it at moderate risk.

**collaboration_width:** 4 — named teams: Sales; Marketing; Finance; Product

**data_team_maturity:** early — Explicitly first full-time data hire, creating the function from clean foundations—classic early-stage signal despite existing infrastructure.

**jd_authorship:** hiring_manager — Highly specific technical responsibilities (dbt Cloud, BigQuery, Basedash, Cursor, Claude Code), AI tooling expectations, and revenue metrics show hiring manager authorship.

**stakeholder_orientation:** commercial — Strong commercial framing: primary goal is enabling GTM/revenue operations metrics and commercial team decisions.

**autonomy_level:** strategic — Strategic ownership language: 'create the function', 'strategic partner', 'drive business decisions'—high autonomy in both strategy and execution.

**greenfield_vs_fix:** greenfield — Greenfield dominant: first data hire, building data function from scratch on clean foundations.
